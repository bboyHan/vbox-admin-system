...
!(function (e) {
      ...
      o = {
        ...
        data: function () {
          return {
            ...
            kefuPath:
              'https://kefurobot.xoyo.com/webchatbot/chat.html?sysNum=1578898069071&sourceId=62211&lang=zh_CN',
          };
        },
        props: [
          'vouch_code',
        ...
        methods: {
          reSelectHandler: function () {
            (this.modal = !1), this.reSelect && this.reSelect();
          },
          checkPayHandler: function () {
            (this.modal = !1), this.confirm && this.confirm();
          },
          copyLink: function () {
            i()(
              'https:' +
                this.orderStatusPath +
                '?item=' +
                this.game +
                '&way=' +
                this.channel +
            ...
            [
              r(
                ...
                [
                  r(
                    ...
                    [
                      ...
                      r(
                        ...
                        [e._v(e._s(e.vouch_code))],
                      ),
                      e._v('（温馨提示：若有疑问，可以尝试点击\n      '),
                      r(
                        'a',
                        {
                          staticClass: 'high-light-color',
                  ...
                  e._v(' '),
                  'qr' === e.handle_method || 'iframe' === e.handle_method
                    ? r(
                        'p',
                        {
                          staticClass: 'lh24',
                  ...
                  r(
                    ...
                    [
                      e._v(
                        '\n      提示：如果' +
                          e._s(e.channel_name) +
                          '页面无法弹出，建议使用IE核心浏览器，点击IE菜单"工具"-"Internet选项"-"安全"，将安全中的各项工具设置回复到默认级别。\n    ',
                      ),
                    ],
                  ),
                  e._v(' '),
                ...
                ? r(
                    ...
                    [
                      r(
                        ...
                        [e._v(e._s(e.config.props.btnText))],
                      ),
                    ],
                  )
                : e._e(),
  ...
  '4RXF': function (e, t, r) {
      ...
      if (e) {
        ...
        return (
          o()(e).forEach(function (r) {
            ~g.indexOf(r) ? ((t[r] = d.encrypt(e[r])), (t.encrypt_method = 'rsa')) : (t[r] = e[r]);
          }),
          t
        );
      }
    ...
    function y(e, t) {
      location.href;
      return (
        l.a.prototype.$requestBeforenum++,
        new n.a(function (r) {
          l.a.prototype
            .$jsonp('' + e, v(_(t)))
            .then(function (e) {
              l.a.prototype.$requestAfternum++, l.a.prototype.$pageAjaxCheckDone(), r(e);
            })
            .catch(function (t) {
    ...
    (window.onbeforeunload = function () {
      ...
      (l.a.prototype.$pageAjaxCheckDone = function () {
        this.$requestBeforenum === l.a.prototype.$requestAfternum &&
          this.$requestCbList.forEach(function (e) {
            e();
          });
      }),
      ...
      methods: {
        markStatisticsReport: function (e) {
          ...
          o()(c).forEach(function (r) {
            r === e &&
              ('Function' === Object.prototype.toString.call(c[r]).slice(8, -1) &&
                t.xoyoStatisticsReport.apply(t, n()(c[r].apply(c, n()(a)))),
              'Array' === Object.prototype.toString.call(c[r]).slice(8, -1) &&
                t.xoyoStatisticsReport.apply(t, n()(c[r])));
          });
        },
      },
      created: function () {
                  ...
                  window.setInterval(function () {
                    ...
                    if (0 === r.indexOf('PM|')) {
                      ...
                      if (
                        ...
                        a.origin &&
                        ('*' === a.origin ||
                          0 === location.href.toLowerCase().indexOf(a.origin.toLowerCase()))
                      )
                  ...
                  }, 20),
                  {
                    send: function (t, a, n) {
                      r.push({
                        ...
                        (function e() {
                          if (
                            (r.timer && (window.clearTimeout(r.timer), delete r.timer), r.length)
                          ) {
                            var t = +new Date(),
                              a = r.lastCheck || 0;
                            if (t < a + 30) r.timer = window.setTimeout(e, a + 30 - t);
                            else {
                              r.lastCheck = t;
                              var n = r.shift();
                              (n.win.name = n.msg), e();
    ...
    t.a = {
      methods: {
        dispatch: function (e, t, r) {
          for (
            var a = this.$parent || this.$root, n = a.$options.componentName;
            a && (!n || n !== e);
        ...
        broadcast: function (e, t, r) {
          (function e(t, r, a) {
            this.$children.forEach(function (n) {
              n.$options.componentName === t
                ? n.$emit.apply(n, [r].concat(a))
                : e.apply(n, [t, r].concat([a]));
            });
          }.call(this, e, t, r));
        },
      },
        ...
        (r('wRxG'),
        {
            ...
            formConfig: function (e) {
              ...
              (this.changFormValueLock = !0),
                (this.formValue = e.items.reduce(function (e, t) {
                  return t.hasOwnProperty('name') && (e[t.name] = t.value), e;
                }, {})),
                setTimeout(function () {
              ...
              antiAddictionModel: function () {
                ...
                return i()({}, this.antiAddiction, {
                  ...
                  checkAntiAddictionStatus: function () {
                    e.checkAntiAddictionStatus(), e.quickPayHandler();
                  },
                  retry: this.retry,
          ...
          methods: i()(
            ...
            }),
            {
              ...
              changeChannel: function (e) {
                this.$store.commit('UPDATE_STEP', 2), this.getCurrentChannel(e);
              },
              submitForm: function (e) {
                e &&
                  (xoyoConsole.log('表单值为', this.formValue), this.createOrder(this.formValue));
              },
              getRefs: function (e) {
                this.refs = e;
              },
              ...
              receiveReselect: function () {
                this.$store.commit('UPDATE_STEP', 2), this.checkOrderReselect();
              },
            },
          ),
          created: function () {
          ...
          mounted: function () {
            ...
            d.e.$emit('active-navigator', 4),
              ...
              (this.ua || this.target || this.no_header) &&
                (d.e.$emit('hidden-layout'),
              ...
              d.e.$on('passport', function (t) {
                if (
                  ...
                  Object(d.f)('order_id') ||
                  Object(d.f)('ua') ||
                  Object(d.f)('no_header')
                )
                  return (e.isLogin = !0), !1;
                if (t) e.isLogin = !0;
                else {
            ...
            [
              r(
                ...
                [
                      ...
                      r(
                        ...
                        [
                                ...
                                r(
                                  ...
                                  [
                                    ...
                                    r(
                                      ...
                                      [e._v(e._s(e.formConfig.pageTitle))],
                                    ),
                                    e._v(' '),
                                    r('span', {
                          ...
                          r(
                            ...
                            [
                              e.formConfig.items.length || e.formConfig.maintenance
                                ? e._e()
                                : r(
                                    'div',
                                    {
                  ...
                  e._v(' '),
                  r('anti-addiction-tip', e._b({}, 'anti-addiction-tip', e.antiAddictionModel, !1)),
                  e._v(' '),
                  r(
                    'anti-addiction-iframe',
                    e._b({}, 'anti-addiction-iframe', e.antiAddictionModel.iframe, !1),
                  ),
                ],
                1,
              ),
          ...
          computed: {
            showJx3Tip: function () {
              return (
                'jx3' === this.gameName &&
                this.orderInfo &&
                this.orderInfo.find(function (e) {
                                ...
                                ? r(
                                    ...
                                    [
                                      r(
                                        ...
                                        [e._v(e._s(t.value && t.value.cost))],
                                      ),
                                      e._v(' '),
                                      r(
                                        'span',
        ...
        function () {
          ...
          return a(
            'div',
            {
              ...
              on: {
                click: function (t) {
                  return t.stopPropagation(), e.clickHandle(t);
                },
              },
            },
            [
              ...
              a(
                ...
                [e._v(e._s(e.option.description))],
              ),
            ],
            1,
          );
  ...
  JiOg: function (e, t, r) {
    ...
    var a = {
      ...
      c = {
        GetCardInfo: function (e) {
          ...
          if (e)
            return (
              13 === e.length && (t = e.substring(0, 2)),
              12 === e.length && ((t = e.substring(3, 5)), (t = '00')),
              o[t]
            );
        },
      },
      ...
      d = {
        ...
        xoyo_password_step: [
          '^[0-9]+$',
          '^[a-zA-Z]+$',
          '^[\\x21-\\x2f\\x3a-\\x3f\\x5b\\x5d-\\x5f\\x60\\x7b\\x7d\\x7e\\x40]+$',
        ],
        space: /\s/,
        duplicate_letter: /^(.)\1+$/,
        gm_filter: /^(gm)/i,
        word_filter:
          /^(bjsupport|kingsoft|cb|ks|gm|test|fs|jx|db|cq|blog|passport|vip|wps|system|duba|ciba|xoyo|kol|shqz|kw3p_|rbtjx3_|kq3p_|sw3p_|kios3p_|@xoyo.com|@kol.com)/i,
        string_filter:
          /pengliyuan|xijinping|hujintao|wenjiabao|jiangzemin|zhurongji|qiubojun|leijun|flg|falun|minghui|lihongzhi|tmd|nmd|fuck|sex|xxx|penis|viagra|tits|pussy|shit|damn|bastard|asshole|bitch|vagina|breast|root|admin|gamemaster|xoyo|kol|kingsoft/i,
        bank_card: '^\\d{15,19}$',
        id_card:
      ...
      m = function (e, t, r) {
        return t.match(d.space)
          ? r(new Error('不能有空格'))
          : d.xoyo_password_step.find(function (e) {
              return t.match(e);
            })
          ? r(new Error('8-32位字母/数字/符号至少两种'))
          : t.match(d.chinese_spell)
          ? r(new Error('不能包含汉字'))
          : void r();
      },
      f = function (e, t, r) {
        if (!t.match(d.common_user_step[0])) return r(new Error('首位必须是字母'));
        if (!t.match(d.common_user_step[1])) return r(new Error('账号格式不正确'));
        if (t.match(/_$/gi)) return r(new Error('账号格式不正确'));
        if (-1 !== t.indexOf('.')) return r(new Error('账号格式不正确'));
        ...
        t &&
          (i.forEach(function (e) {
            if (t.toLocaleLowerCase().match(e)) return r(new Error('账号包含非法字符'));
          }),
      ...
      M = new ((function (e) {
        function t() {
          return S()(this, t), E()(this, (t.__proto__ || A()(t)).apply(this, arguments));
        }
        return (
          N()(t, e),
          j()(t, [
            {
              ...
              value: function (e) {
                ...
                } else P()(t.prototype.__proto__ || A()(t.prototype), 'report', this).call(this);
              },
            },
            {
              key: 'trackClick',
    ...
    function q(e) {
      var t = u()(U),
        r = u()(e);
      return xoyoConsole.log('两者比较', t, r, t === r), t === r || ((U = JSON.parse(r)), !1);
    }
    var F = (function () {
        function e() {
          S()(this, e),
        ...
        return (
          j()(e, [
            ...
            },
            {
              key: 'verify',
              value: function () {
                return this.onSuccessHandler(), this.data;
              },
            },
            {
              key: 'onSuccess',
    ...
    var te = function () {
      ...
      if (
        !(e = t) ||
        ('object' !== (void 0 === e ? 'undefined' : ee()(e)) && 'function' != typeof e) ||
        'function' != typeof e.then
      )
        throw new Error('请输入一个promise函数');
      return X()(r).length || xoyoConsole.warning('authParams 参数将被忽略'), t();
    };
    function re(e, t) {
    ...
    var ie = function e(t, r) {
        document.querySelector,
          document.querySelector &&
            ((document.querySelector('.auto-tips').style.display = 'block'),
        ...
        var a = setTimeout(function () {
          0 !== t
            ? e(t - 1, r)
            : (document.querySelector &&
                (ae(document.querySelector('.auto-tips-content'), 'auto-tips-fade-out'),
        ...
        return (
          j()(e, [
            ...
            },
            {
              key: 'getCostTime',
              value: function (e) {
                var t = Math.ceil(0.3 * Math.pow(2, this.requestTime));
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (r = this.getCostTime(t)), (e.next = 3), this.delay(r);
                            case 3:
                            case 'end':
                              return e.stop();
                          }
            ...
            },
            {
              ...
              value: function () {
                ...
                return this.needAuth && !this.preAuthRequest
                  ? Object(J.a)(e, w()({}, this.authParams))
                  : this.preAuthRequest
                  ? te(this.preAuthRequest, this.authParams)
                  : V.a.resolve();
              },
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  ...
                  this.getTicketRequest
                    ? te(this.getTicketRequest.bind(this, this.ticket), this.ticketParams)
                    : Object(J.a)(
                        t,
                        w()(
                          {
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  (this.requestTime = this.requestTime + 1),
                  this.getTicketRequest
                    ? te(this.getResultRequest.bind(this, this.ticket), this.resultParams)
                    : Object(J.a)(
                        e,
                        w()(
                          {
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.getTicket(t);
                            case 2:
                              if (
                                ((r = e.sent),
                                (a = r.code),
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.getResult();
                            case 2:
                              if (((t = e.sent), (r = t.code), (a = t.data), 1 * r != -30105)) {
                                e.next = 15;
                                break;
                              }
                              return (
                            ...
                            case 10:
                              return (e.next = 12), this.getResultHandler();
                            case 12:
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.getStatus();
                            case 2:
                              if (
                                ((t = e.sent),
                                (r = t.code),
                            ...
                            case 11:
                              return (e.next = 13), this.getResultHandler();
                            case 13:
                              return e.abrupt('return', e.sent);
                            case 16:
                              if (!(r > 0)) {
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.getStatusHandler();
                            case 2:
                              return (this.result = e.sent), e.abrupt('return', this.result);
                            case 4:
                            case 'end':
                              return e.stop();
                          }
                    ...
                    return Z.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.preAuth();
                            case 2:
                              return (e.next = 4), this.getTicketHandler(t);
                            case 4:
                              if ((r = e.sent)) {
                                e.next = 14;
                                break;
                              }
                              return (e.next = 8), this.renderCountDown(this.waiting);
                            case 8:
                              return (e.next = 10), this.getResultHandler();
                            case 10:
                              return (this.result = e.sent), e.abrupt('return', this.result);
                            case 14:
    ...
    function he() {
      ...
      return (
        t.length > 1 &&
          (t = t[1].split('&')).forEach(function (e) {
            (e = e.split('=')), (r[e[0]] = e[1]);
          }),
        e ? u()(r) : r
      );
  ...
  Ly1x: function (e, t, r) {
    ...
    var a = {
        ...
        methods: {
          clickHandle: function (e) {
            if (this.disabled)
              return this.$xoyo_api_common.warningDialog('当前状态下，不可更改充值方式！'), !1;
            this.change && this.change(e), e.url || (this.currentId = e.id);
          },
        },
      },
      n = r('JFUb');
        ...
        return (
          ...
          m()(e, [
            ...
            },
            {
              ...
              value: function (e) {
                (0, e.commit)('CLOSE_ANTI_ADDICTION_TIPS');
              },
            },
            {
              key: 'changeReLogin',
              value: function (e) {
                (0, e.commit)('SET_STATUS', g.reLogin);
              },
            },
            {
              key: 'retry',
              value: function (e) {
                (0, e.commit)('SET_STATUS', g.default);
              },
            },
            {
              key: 'validate',
              value: function (e) {
                var t = e.commit;
                t('SET_STATUS', g.validate), t('OPEN_ANTI_ADDICTION_IFRAME');
              },
            },
            {
              key: 'reLogin',
            ...
            },
            {
              key: 'openTipsModal',
              value: function (e) {
                (e.visible = !0), (e.timestamp = new Date().getTime());
              },
            },
            {
              key: 'closeTipsModal',
              value: function (e) {
                (e.visible = !1), (e.timestamp = new Date().getTime());
              },
            },
          ]),
          e
  ...
  'c6A/': function (module, __webpack_exports__, __webpack_require__) {
    ...
    function getUrlParams(name) {
      ...
      return null !== r
        ? ~['true', 'false'].indexOf(decodeURIComponent(r[2]))
          ? eval(decodeURIComponent(r[2]))
  ...
  iNKB: function (e, t, r) {
    ...
    var n = function (e) {
      ...
      c = {
        ...
        methods: {
          update: function () {
            (this.innerStatus = !1), this.changeStatus && this.changeStatus();
          },
                ...
                : r(
                    ...
                    [
                      ...
                      r(
                        ...
                        [e._v('（若留空则给当前登录账号' + e._s(e.account) + '充值）')],
                      ),
                    ],
                    1,
                  ),
            ...
            ? r(
                ...
                [
                  ...
                  r(
                    ...
                    [e._v('最近选择: ' + e._s(e.recentServerName))],
                  ),
                ],
                1,
              )
      ...
      x = {
        ...
        watch: {
          form: {
            handler: function (e) {
              ...
              r &&
                this.getChargeType &&
                r.cardType !== this.cardInfo.cardType &&
                ((this.cardInfo = r), this.getChargeType(r));
            },
            deep: !0,
          },
        },
        methods: {
          getRule: function (e) {
            return {
              kcard_num: [
                ...
                {
                  validator: function (e, t, r) {
                    if (!o.h.GetCardInfo(t)) return r(new Error('金山一卡通格式不正确'));
                    r();
                  },
                  trigger: ['blur', 'change'],
                },
          ...
          closeKcardModal: function () {
            (this.kcardForm = {}), (this.kcardModal = !1);
          },
                        ...
                        case 13:
                          (i = e.sent),
                            ...
                            o > 0 && 6006 !== o
                              ? ((this.kcardForm = c),
                                (this.kcardModal = !0),
                                this.xoyoStatisticsReport(
                                  'ch_kcard_status_click',
                                  '点击一卡通有效性查询',
                                  {
                              ...
                              : (this.$xoyo_api_common.errorDialog(s),
                                this.xoyoStatisticsReport(
                                  'ch_kcard_status_click',
                                  '点击一卡通有效性查询',
                                  {
                      ...
                      r(
                        ...
                        [
                          ...
                          r(
                            ...
                            [e._v(e._s(e.kcardForm.card_type))],
                          ),
                        ],
                      ),
                      e._v(' '),
                      r(
                        ...
                        [
                          ...
                          r(
                            ...
                            [e._v(e._s(e.kcardForm.card_status))],
                          ),
                        ],
                      ),
                      e._v(' '),
                      r(
                        ...
                        [
                          ...
                          r(
                            ...
                            [e._v(e._s(e.kcardForm.end_date))],
                          ),
                        ],
                      ),
                      e._v(' '),
                          ...
                          r(
                            ...
                            [
                              ...
                              r(
                                ...
                                [e._v(e._s(e.kcardForm.recharge_product))],
                              ),
                            ],
                          ),
                          e._v(' '),
                          r(
                            ...
                            [
                              ...
                              r(
                                ...
                                [e._v(e._s(e.kcardForm.recharge_passport))],
                              ),
                            ],
                          ),
                          e._v(' '),
                          r(
                            ...
                            [
                              ...
                              r(
                                ...
                                [e._v(e._s(e.kcardForm.recharge_time))],
                              ),
                            ],
                          ),
                          e._v(' '),
                          r(
                            ...
                            [
                              ...
                              r(
                                ...
                                [e._v(e._s(e.kcardForm.recharge_client_ip))],
                              ),
                            ],
                          ),
                        ],
    ...
    var S,
      ...
      G = {
        ...
        components: ((S = {}), P()(S, D.a.name, D.a), P()(S, N.a.name, N.a), S),
        methods: {
          getRules: function (e) {
            return {
              recharge_type: [
            ...
            return {
              recharge_unit: [
                ...
                },
                {
                  validator: function (e, r, a) {
                    if (-2e3 === r[0] && !r[1])
                      return (t.customWarning = !0), a(new Error('充值' + t.unitType + '不能为空'));
                    (t.customWarning = !1), a();
                  },
                  trigger: 'change',
                },
          ...
          return a(
            ...
            [
              ...
              a(
                ...
                [
                  a('p', [e._v(e._s(e.option.description))]),
                  e._v(' '),
                  a(
                    'p',
                    {
            ...
            confirmRule: {
              confirm: {
                ...
                validator: function (t, r, a) {
                  ...
                  if (r.trim() !== n) return a(new Error('请输入正确的确认文案'));
                  a();
                },
                trigger: 'change',
              },
        ...
        methods: {
          ...
          handleConfirm: function () {
            ...
            this.$refs.confirmForm.validate(function (t) {
              t && ((e.confirmForm.confirm = ''), (e.confirmVisible = !1));
            });
    ...
    var Z = function (e) {
                  ...
                  r(
                    ...
                    [
                      ...
                      r(
                        ...
                        [e._v('我确认充值' + e._s(e.form[e.prop][1]) + '元人民币')],
                      ),
                      e._v(' '),
                      r(
                        'el-form',
      ...
      K = {
        ...
        updated: function () {
          ...
          this.refs.validateField('recharge_unit', function (t) {
            xoyoConsole.log('检测到更新值', t), (e.show = !t);
          });
        },
      },
      z = Object(a.a)(
      ...
      W = {
        ...
        methods: {
          add: function () {
            this.length > this.value.length &&
              (this.xoyoStatisticsReport('order_ks_list_add', '点击增加金山一卡通', {}, [
                'xoyo_game_order',
              ]),
        ...
        created: function () {
          this.$on('delOption', this.del), this.$on('change', this.change);
        },
        updated: function () {
    ...
    var X = function (e) {
      ...
      ee = {
        ...
        methods: {
          ...
          del: function () {
            this.xoyoStatisticsReport('order_ks_list_del', '点击删除金山一卡通', {}, [
              'xoyo_game_order',
            ]),
    ...
    var te,
                        ...
                        directives: [
                          {
                            ...
                            expression:
                              "{eventName: 'order_ks_serial', eventDescription: '点击金山卡号输入框',  eventTags: ['xoyo_register;pc'],\n                      listenEvent: 'focus',\n                      queryElement: function(){\n                       return this.children[0]\n                      }}",
                          },
                        ],
                        staticStyle: {
                          width: '148px',
                        ...
                        directives: [
                          {
                            ...
                            expression:
                              "{eventName: 'order_ks_password', eventDescription: '点击金山卡密输入框',  eventTags: ['xoyo_register;pc'],\n                      listenEvent: 'focus',\n                      queryElement: function(){\n                       return this.children[0]\n                      }}",
                          },
                        ],
                        staticStyle: {
                          width: '148px',
      ...
      ie = {
        ...
        components: ((te = {}), P()(te, D.a.name, D.a), P()(te, N.a.name, N.a), te),
        methods: {
          getRules: function (e) {
            return null;
          },
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (
                            this.$xoyo_api_common.warningDialog('请仔细阅读并同意金山充值服务条款'),
                            e.abrupt('return', !1)
                          );
                        case 4:
                          return (e.next = 6), this.validateForm('formPay');
                        case 6:
                      ...
                      directives: [
                        {
                          ...
                          expression:
                            "{eventName: 'ch_sub_form_click', eventDescription: '点击立即充值按钮', eventTags: ['xoyo_charge']}",
                        },
                        {
                          name: 'data-report',
  ...
  tJFH: function (e, t, r) {
    ...
    var n = {
      ...
      seo: {
        ...
        siteKeywords:
          '金山西山居,金山公司,逍遥,逍遥网,xoyo,Kingsoft,MMORPG,MMOG,在线游戏,网络游戏,游戏下载,免费游戏,免费网游,角色扮演,休闲游戏,剑网3,剑侠贰外传,剑侠世界,剑侠情缘网络版贰,剑侠情缘网络版,封神榜,春秋Q传,反恐行动,西山居,亚丁工作室,鲸彩工作室,金山客服,金山网游客户服务,金山游戏官网,在线充值',
      },
  ...
  vUrQ: function (e, t, r) {
    ...
    var y = n()(
      ...
      _('kcoinQuotaSetting'),
      _('kcoinPwdSetting'),
      _('kcoinConsumeRecord'),
      _('chargeItems'),
      _('gameOrderPay'),
      _('gameClientPay'),
      _('commonGameClientPay'),
      _('orderStatus'),
      _('pay'),
      _('invoice'),
      _('invoiceRecord'),
      ...
      _('news'),
      _('newsList'),
      _('mobileGameExclusivePay'),
      {
        passwordUpgradeTipPath: {
          js:
            'https://zhcdn01.xoyo.com/xassets/lib/password-danger-tip/0.0.x/' +
            (~['production', 'prelease'].indexOf('production') ? 'master' : 'test') +
            '/password-danger-tip.umd.js',
          css:
            'https://zhcdn01.xoyo.com/xassets/lib/password-danger-tip/0.0.x/' +
            (~['production', 'prelease'].indexOf('production') ? 'master' : 'test') +
            '/style.css',
  ...
  xHOL: function (e, t, r) {
            ...
            },
            {
              ...
              value: function (e, t, r, a, i) {
                ...
                var f = this.settingFormValue(o),
                  g = this.getUnit(f);
                return (
                  xoyoConsole.log('配置formConfig', e, t, r, a),
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.config,
                  ...
                  m = this.getUnit(d);
                return (
                  xoyoConsole.log('update配置formConfig', t, r, a, i),
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 5:
                              if (((i = e.sent), (o = i.state), (c = i.data), 1 !== o)) {
                                e.next = 12;
                                break;
                              }
                              return (
                                D.$xoyo_api_common.captchaHandler.reset(),
      ...
      L = [
        ...
        },
        {
          ...
          events: {
            onClick: function (e) {
              'account' === e &&
                G.xoyoStatisticsReport('ch_acc_input_click', '点击充值账号输入框', {}, [
                  'xoyo_charge',
                ]),
                'repeatAccount' === e &&
                  G.xoyoStatisticsReport('ch_acc_cf_input_click', '点击确认账号输入框', {}, [
                    'xoyo_charge',
                  ]);
            },
        ...
        },
        {
          ...
          events: {
            onClick: function (e, t) {
              'receiveInput' === e &&
                (G.xoyoStatisticsReport('ch_kcard_num_click', '点击订单接收输入框', {}, [
                  'xoyo_charge',
                ]),
        ...
        },
        {
          ...
          events: {
            onClick: function (e) {
              'kcardNum' === e &&
                (G.xoyoStatisticsReport('ch_kcard_num_click', '点击一卡通号码输入框', {}, [
                  'xoyo_charge',
                ]),
                G.dataReport.chKcardNumClick()),
                'kcardPassword' === e &&
                  (G.xoyoStatisticsReport('ch_kcard_pass_click', '点击一卡通密码输入框', {}, [
                    'xoyo_charge',
                  ]),
        ...
        },
        {
          ...
          events: {
            onClick: function (e) {
              'kcoinPwd' === e &&
                (G.xoyoStatisticsReport('ch_kcoin_pass_click', '点击金山币支付密码输入框', {}, [
                  'xoyo_charge',
                ]),
                G.dataReport.chKcoinPassClick()),
                'forgetKcoinPwd' === e &&
                  G.xoyoStatisticsReport('ch_kcoin_forget_click', '点击金山币忘记支付密码', {}, [
                    'xoyo_charge',
                  ]);
            },
          },
          ...
          b()(
            ...
            [
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return e.abrupt(
                                  'return',
                                  H.$xoyo_api_pay.gameChannelInformation({
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  (xoyoConsole.log('当前业务类型', this.source || '普通充值'),
                                  (r = o.id),
                                  (a = o.url),
                                  (n = o.name),
                                  H.xoyoStatisticsReport(
                                    'payWay',
                                    '选择支付方式',
                                    {
                                      el_val: n,
                                ...
                                return (
                                  'game-webview' === c ? (location.href = a) : window.open(a),
                                  e.abrupt('return', {})
                                );
                              case 7:
                                return e.abrupt(
                                  'return',
                                  H.$xoyo_api_pay.rechargeInformation({
                                    game: i.id,
                                    channel: r,
                                    recharge_source: this.source,
                                  }),
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 9:
                                ...
                                if (((h = p.handle_method), (m = p.resource_url), !we[i[h]])) {
                                  e.next = 19;
                                  break;
                                }
                                if (we[i[h]](m, r)) {
                              ...
                              case 24:
                                return (
                                  -71528 === u || -71529 === u
                                    ? H.$xoyo_api_common.warningDialog(
                                        '对不起，您的账号未通过防沉迷认证，暂不能充值！请点击<a style="color: #f00" href="' +
                                          w.a.antiAddiction.path +
                                          '">>补填防沉迷<</a>',
                                        function () {},
                                        3e3,
                                        !0,
                                      )
                                    : H.$xoyo_api_common.warningDialog(l),
                                  o && o.close(),
                                  e.abrupt('return', !1)
                                );
                              case 27:
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 4:
                                ...
                                (e.t0 = i.order_status), (e.next = 2 === e.t0 ? 13 : 17);
                                break;
                              case 13:
                                return (
                                  (i.order_status_text = '充值成功！'),
                                  H.xoyoStatisticsReport(
                                    'ch_pay_finish',
                                    '充值订单状态成功',
                                    {
                              ...
                              case 23:
                                return (
                                  H.$xoyo_api_common.errorDialog(n),
                                  H.xoyoStatisticsReport(
                                    'ch_pay_fail',
                                    '充值订单状态失败',
                                    {
              ...
              },
              {
                ...
                value: function () {
                  H.xoyoStatisticsReport('ch_confirm_reset_click', '点击订单重新选择', {}, [
                    'xoyo_charge',
                  ]),
              ...
              },
              {
                ...
                value: function () {
                  H.xoyoStatisticsReport('ch_pay_reset_click', '点击订单重新选择', {}, [
                    'xoyo_charge',
                  ]),
                    H.dataReport.chPayResetClick();
                },
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 11:
                                if (((s = e.sent), (u = s.state), (l = s.data), 1 !== u)) {
                                  e.next = 18;
                                  break;
                                }
                                return (
                                  H.$xoyo_api_common.captchaHandler.reset(),
                              ...
                              case 19:
                                ...
                                break;
                              case 21:
                                return (e.prev = 21), (e.t0 = e.catch(8)), e.abrupt('return', !1);
                              case 24:
                              case 'end':
                                return e.stop();
                            }
          ...
          b()(
            ...
            [
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return e.abrupt(
                                  'return',
                                  q.$xoyo_api_pay.gameChannelInformation({
                                    recharge_source: this.source,
                                  }),
                                );
                              case 1:
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 7:
                                return e.abrupt(
                                  'return',
                                  q.$xoyo_api_pay.rechargeInformation({
                                    game: i.id,
                                    channel: r,
                                    recharge_source: this.source,
                                  }),
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 24:
                                return (
                                  -71528 === u || -71529 === u
                                    ? q.$xoyo_api_common.warningDialog(
                                        '对不起，您的账号未通过防沉迷认证，暂不能充值！请点击<a style="color: #f00" href="' +
                                          w.a.antiAddiction.path +
                                          '">>补填防沉迷<</a>',
                                        function () {},
                                    ...
                                    : q.$xoyo_api_common.warningDialog(l),
                                  o && o.close(),
                                  e.abrupt('return', !1)
                                );
                              case 27:
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 23:
                                return (
                                  q.$xoyo_api_common.errorDialog(n),
                                  q.xoyoStatisticsReport(
                                    'ch_pay_fail',
                                    '充值订单状态失败',
                                    {
              ...
              },
              {
                key: 'payOrderReselect',
                value: function () {
                  q.xoyoStatisticsReport('ch_confirm_reset_click', '点击订单重新选择', {}, [
                    'xoyo_charge',
                  ]),
              ...
              },
              {
                key: 'checkOrderReselect',
                value: function () {
                  q.xoyoStatisticsReport('ch_pay_reset_click', '点击订单重新选择', {}, [
                    'xoyo_charge',
                  ]),
                    q.dataReport.chPayResetClick();
                },
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 11:
                                ...
                                return (
                                  q.$xoyo_api_common.captchaHandler.reset(),
                                  e.abrupt('return', n()({}, a, l))
                                );
                              case 18:
                                return e.abrupt('return', !1);
      ...
      V = [
        ...
        },
        {
          ...
          events: {
            onClick: function (e, t) {
              'receiveInput' === e &&
                z.xoyoStatisticsReport('order_order_rec_click', '点击订单接收输入框', {}, [
                  'xoyo_game_order',
                ]);
            },
            onChange: function (e, t) {
              if ('receiveSelect' === e) {
                z.xoyoStatisticsReport(
                  'order_order_query_select',
                  '选择订单接收方式',
                  {
                    el_val: {
                      phone: '手机接收',
            ...
            [
              {
                ...
                value: function (e, r, a, n, i) {
                  var o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {},
                    c = K()(t.prototype.__proto__ || A()(t.prototype), 'setformConfig', this).call(
                      this,
                      e,
                      r,
                      a,
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (t = J.$xoyo_api_pay.gameStoreChannelInforamtion({
                                    recharge_source: this.source,
                                  })),
                                  e.abrupt('return', t)
                                );
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                ...
                                return (location.href = a), e.abrupt('return', {});
                              case 6:
                                return e.abrupt(
                                  'return',
                                  J.$xoyo_api_pay.gameStoreRechargeInformation({
                                    game: i.id,
                                    channel: r,
                                    order_id: c,
                                    recharge_source: this.source,
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  ...
                                  (e.next = 8),
                                  J.$xoyo_api_pay.gameStoreCreateOrder(
                                    n()({}, a, {
                                      order_id: r,
                                      recharge_source: this.source,
                                    }),
                              ...
                              case 8:
                                ...
                                if (((h = p.handle_method), (m = p.resource_url), !we[o[h]])) {
                                  e.next = 18;
                                  break;
                                }
                              ...
                              case 21:
                                return (
                                  J.$xoyo_api_common.warningDialog(l),
                                  c && c.close(),
                                  e.abrupt('return', !1)
                                );
                              case 24:
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 3:
                                ...
                                (e.t0 = i.order_status), (e.next = 2 === e.t0 ? 12 : 15);
                                break;
                              case 12:
                                return (
                                  (i.order_status_text = '充值成功！'),
                              ...
                              case 20:
                                return (
                                  J.$xoyo_api_common.errorDialog(n),
                                  J.xoyoStatisticsReport(
                                    'order_pay_fail',
                                    '充值订单状态失败',
                                    {
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 19:
                                return (
                                  J.$xoyo_api_common.warningDialog(c),
                                  n && n.close(),
                                  e.abrupt('return', !1)
                                );
                              case 22:
              ...
              },
              {
                key: 'payOrderReselect',
                value: function () {
                  J.xoyoStatisticsReport('order_confirm_reset_click', '点击订单重新选择', {}, [
                    'xoyo_game_order',
                  ]);
                },
              },
              {
                key: 'checkOrderReselect',
                value: function () {
                  J.xoyoStatisticsReport('order_pay_reset_click', '点击订单重新选择', {}, [
                    'xoyo_game_order',
                  ]);
                },
              },
    ...
    var $ = X,
      ...
      te = (function (e) {
        function t(e, r) {
          ...
          return (
            (a.submitButtonText = '立即支付'),
            (a.tipsName = 'storeTip'),
            (a.source = t.getSign(e)),
            P()(ee[e]) &&
              P()(ee[e]).forEach(function (t) {
                a[t] = Object(k.f)('charge_title')
                  ? decodeURIComponent(Object(k.f)('charge_title'))
                  : ee[e][t];
              }),
            (a.redirect = r),
            a
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (e.next = 2),
                                  K()(
                                    t.prototype.__proto__ || A()(t.prototype),
                                    'checkOrder',
                                    this,
                                  ).call(this, r)
                                );
                              case 2:
                                return (
                                  (a = e.sent) &&
                                    ...
                                    setTimeout(function () {
                                      window.PM &&
                                        window.PM.send(window.parent, 'fromFrame', {
                                          url: n.redirect,
                                        });
                                    }, 1e3),
                                  e.abrupt('return', a)
          ...
          b()(
            ...
            [
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (t = ae.$xoyo_api_pay.gameClientChannelInforamtion({})),
                                  e.abrupt('return', t)
                                );
                              case 2:
                              case 'end':
              ...
              },
              {
                ...
                value: function (e, t) {
                  var r = e.title,
                    ...
                    n = this.config;
                  return (
                    xoyoConsole.log('confirmOrder', n),
                    {
                      orderInfo: [
                        {
                          key: 'passport',
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  ...
                                  'http_redirect' === i && (c = we.openWindow('game-webview')),
                                  (e.next = 9),
                                  ae.$xoyo_api_pay.gameClientCreateOrder(
                                    n()({}, a, {
                                      order_id: r,
                                    }),
                                  )
                              ...
                              case 22:
                                return (
                                  ae.$xoyo_api_common.warningDialog(l),
                                  c && c.close(),
                                  e.abrupt('return', !1)
                                );
                              case 25:
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 20:
                                return (
                                  ae.$xoyo_api_common.errorDialog(n),
                                  ae.xoyoStatisticsReport(
                                    'order_pay_fail',
                                    '充值订单状态失败',
                                    {
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 19:
                                return (
                                  ae.$xoyo_api_common.warningDialog(c),
                                  n && n.close(),
                                  e.abrupt('return', !1)
                                );
                              case 22:
              ...
              },
              {
                key: 'payOrderReselect',
                value: function () {
                  ae.xoyoStatisticsReport('order_confirm_reset_click', '点击订单重新选择', {}, [
                    'xoyo_game_order',
                  ]);
                },
              },
              {
                key: 'checkOrderReselect',
                value: function () {
                  ae.xoyoStatisticsReport('order_pay_reset_click', '点击订单重新选择', {}, [
                    'xoyo_game_order',
                  ]);
                },
              },
          ...
          b()(e, [
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.config,
                  r = t.game_group;
                return (
                  console.log('gameGroupHandler', t),
                  {
                    props: {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (e.gateway) (m.value = e.gateway), (e.gateway = e.gateway);
                else if (i && f) (m.value = i), (e.gateway = i);
                else if (d.options.length)
                  if (l.length) {
                    var g = l[0];
                    (m.value = g.value), (e.gateway = g.value);
                  } else (m.value = d.options[0].value), (e.gateway = d.options[0].value);
                return (
                  o && (d.disabled = o),
                  (d.gameName = a.name),
                  xoyoConsole.log('gatewayHandler', p()(d), n),
                  n.length && ((d.options = []), xoyoConsole.log('当有game_group时隐藏', d)),
                  {
                    props: d,
                    value: m,
                  }
            ...
            },
            {
              ...
              value: function (t) {
                var r = this.config,
                  ...
                  u = {};
                return (
                  n !== e.lastRechargeType && ((e.lastRechargeType = n), (t.recharge_unit = [])),
                  c.hasOwnProperty('support_recharge_type') &&
                    (s.options = o.filter(function (e) {
                  ...
                  s.options.filter(function (e) {
                    ...
                    ? (u.value = n)
                    : ((u.value = s.options[0].recharge_type),
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.config,
                  ...
                  o = {},
                  c = {};
                if (((o.typeName = '元'), (this.unitType.type = '元'), 'number' == typeof r)) {
                  var s =
                      n.filter(function (e) {
                    ...
                    l = s.custom_unit,
                    p = s.unit_name;
                  (o.extra = l), (o.options = u), (o.unitName = p), (this.unitType.unit = p);
                } else o.options = [];
                (/hfb/.test(i) &&
                  (o.tips =
                    '温馨提示：您点选的“充值金额”必须与您的充值卡面额一致，否则导致充值失败或充值卡内金额丢失的责任，由您自行承担！'),
                a && 'number' == typeof a[0])
                  ? o.options.filter(function (e) {
                      return e.cost === a[0];
                    }).length
                    ? (c.value = a)
                    : -2e3 === a[0] && o.extra && (c.value = a)
                  : ((e.recharge_unit = []), (c.value = []));
                return (
                  c.value && c.value.length && -2e3 !== c.value[0] && (c.value[1] = ''),
                  {
                    props: o,
                    value: c,
                  }
              ...
              value: function (e) {
                ...
                if (c && o.length) {
                  ...
                  if (-2e3 !== o[0]) {
                    ...
                    p && ((a.gain = p.gain), (a.cost = o[0]));
                  } else if (l) {
                    var h = l.cost,
                      d = l.gain;
                    (a.gain = (o[1] / h) * d), (a.cost = a.gain && o[1]);
                  }
                }
                return {
                  props: a,
    ...
    (ce.lastRechargeType = ''), (ce.gameName = '');
    var se = ce,
      ue = (function (e) {
        function t() {
          return y()(this, t), S()(this, (t.__proto__ || A()(t)).apply(this, arguments));
        }
        return (
          j()(t, e),
          b()(t, [
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                var r = e.kcard,
                  ...
                  i = n.props,
                  o = n.value;
                if (((this.kcardInfo = k.h.GetCardInfo(r && r[0])), this.kcardInfo)) {
                ...
                return (
                  i.options.length
                    ? i.options.filter(function (e) {
                      ...
                      ? (o.value = a)
                      : ((o.value = i.options[0].recharge_type),
                        (e.recharge_type = i.options[0].recharge_type),
                        (se.lastRechargeType = i.options[0].recharge_type))
                    : ((o.value = ''), (e.recharge_type = ''), (se.lastRechargeType = '')),
                  {
                    props: i,
                    value: o,
                  }
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                ...
                (i.options &&
                  i.options.length &&
                  (i.options = i.options.map(function (e) {
                    return n()({}, e, {
                      cost: 1 * e.gain,
                      gain: e.cost,
                    });
                ...
                r && 'number' == typeof r[0])
                  ? i.options.filter(function (e) {
                    ...
                    ? ((o.value = r), (e.recharge_unit = r))
                    : -2e3 === r[0] && i.extra && ((o.value = r), (e.recharge_unit = r))
                  : ((e.recharge_unit = []), (o.value = []));
                return (
                  o.value && o.value.length && -2e3 !== o.value[0] && (o.value[1] = ''),
                  {
                    props: i,
                    value: o,
                  }
              ...
              value: function (e) {
                ...
                if (c) {
                  ...
                  if (-2e3 !== o[0]) {
                    ...
                    p && ((a.gain = p.gain), (a.cost = p.cost));
                  } else if (l) {
                    var h = l.cost;
                    l.gain;
                    (a.gain = o[1]), (a.cost = o[1] * h);
                  }
                }
                return {
                  props: a,
      ...
      me = (function (e) {
        function t() {
          ...
          return (
            (r = a = S()(this, (e = t.__proto__ || A()(t)).call.apply(e, [this].concat(o)))),
            (a.chargeTypeEum = {
              tongbao: 6,
              yueka: 1,
              dianka: 2,
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                var t = this.config,
                  ...
                  p = a[r];
                if (
                  (i !== se.lastRechargeType && ((se.lastRechargeType = i), (e.recharge_unit = [])),
                  s.hasOwnProperty('support_recharge_type') &&
                    (u.options = c.filter(function (e) {
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                var t = this.config,
                  ...
                  i = {};
                return (
                  r !== se.lastRechargeType && ((se.lastRechargeType = r), (e.recharge_unit = [])),
                  (n.options = a),
                  n.options.filter(function (e) {
                    return e.recharge_type === r;
                  }).length
                    ? (i.value = r)
                    : ((i.value = n.options[0].recharge_type),
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                var r = e.recharge_type,
                  ...
                  i = n.props,
                  o = n.value;
                if (((this.kcardInfo = k.h.GetCardInfo(a && a[0])), this.kcardInfo)) {
                  var c = this.kcardInfo.cardType;
                  i.options = i.options.filter(function (e) {
                    return e.units.filter(function (e) {
                      return e.cost === c;
        ...
        return (
          b()(e, null, [
            ...
            },
            {
              ...
              value: function (e, t, r) {
                ...
                n)) {
                  ...
                  (o.type = 'hidden'), (o.name = i), (o.value = n[i]), a.appendChild(o);
                }
            ...
            },
            {
              key: 'httpRedirect',
              value: function (t, r) {
                return 'game-webview' === r ? (location.href = t) : (e.win.location = t), !0;
              },
            },
            {
        ...
        return (
          b()(e, [
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 4:
                              return (e.next = 6), this.prefession.getBaseInfo();
                            case 6:
                              if (
                                ((t = e.sent),
                                (r = t.status),
                              ...
                              if (
                                ((s = this.getExtraIcons(o, this.name)),
                                (u = c.map(function (e) {
                                  return n()({}, e, {
                                    extraIcon: s[e.id] || !1,
                                  });
                              ...
                              return e.abrupt('return', this.noGameTips());
                            case 17:
                              this.channelHandle(u, this.gameInfo.support_channels), (e.next = 21);
                              break;
                            case 20:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 5:
                              ...
                              return e.abrupt(
                                'return',
                                this.prefession.setformConfig(
                                  s,
                                  this.extraFormConfig,
                                  t,
                                  this.gameInfo,
                                  this.extraParams,
                                  r,
            ...
            },
            {
              ...
              value: function (e) {
                e
                  ? Ce.$xoyo_api_common.errorDialog('所在游戏不存在或已下线', function () {}, 0)
                  : Ce.$xoyo_api_common.errorDialog(
                      '所在游戏不存在或已下线，即将跳转到充值首页',
                      function () {
                    ...
                    return d.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.prefession.createOrder(t, r);
                            case 2:
                              return e.abrupt('return', e.sent);
                            case 3:
                            case 'end':
                    ...
                    return d.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (r = this.ua), (e.next = 3), this.prefession.payOrder(t, r);
                            case 3:
                              if (!(a = e.sent)) {
                                e.next = 10;
                                break;
                            ...
                            case 7:
                              return e.abrupt(
                                ...
                                n()({}, a, {
                                  isAccessCopy:
                                    'boolean' == typeof this.prefession.isAccessCopy
                                      ? this.prefession.isAccessCopy
                                      : !!~Ae.indexOf(this.name),
                                }),
                              );
                            case 10:
                              return e.abrupt('return', a);
                    ...
                    return d.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this.prefession.checkOrder(t);
                            case 2:
                    ...
                    return d.a.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (r = this.ua), (e.next = 3), this.prefession.rePayOrder(t, r);
                            case 3:
                              if (!(a = e.sent)) {
                                e.next = 10;
                                break;
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 2:
                                return (n = e.sent), e.abrupt('return', this.addTips(n));
                              case 4:
                              case 'end':
                                return e.stop();
                            }
        ...
        return (
          ...
          b()(t, [
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 2:
                              return (n = e.sent), e.abrupt('return', this.resultHandler(n));
                            case 4:
                            case 'end':
                              return e.stop();
                          }
            ...
            },
            {
              key: 'changFormValue',
              value: function (e) {
                var r = K()(t.prototype.__proto__ || A()(t.prototype), 'changFormValue', this).call(
                  this,
                  e,
                );
          ...
          b()(t, [
            {
              ...
              value: function (e) {
                var t = e.items;
                return (
                  (e.items = t.reduce(function (e, t) {
                    t.itemName, t.props;
                    return e.push(t), [].concat(u()(e));
                  }, [])),
                  e
                );
              },
          ...
          b()(e, null, [
            {
              key: 'clone',
              value: function (e) {
                return (e.timestamp = new Date().getTime()), n()(Te()(A()(e)), e);
              },
            },
          ]);
        })(),
          ...
          b()(
            ...
            [
                        ...
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), this.game.getGameInfo();
                              case 2:
                                (a = t.sent),
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 4:
                                (i = e.sent) && (xoyoConsole.log('表单信息', i), o(Le, i)),
                            ...
                            switch ((e.prev = e.next)) {
                              ...
                              case 3:
                                (a = e.sent),
                                  ...
                                  (this.params = a),
                                  a &&
                                    ((i = this.game.confirmOrder(c.fromConfig, a)),
                                    o(
                                      Me,
                                      n()({}, i, {
                                        visible: !0,
                              ...
                              case 9:
                                a &&
                                  ('nothing' === (i = a.handle_method)
                                    ...
                                    : o(
                                        qe,
                                        'http_post_redirect' === i ||
                                          'http_post_form_redirect' === i
                                          ? n()({}, a)
                                          : n()({}, a, {
                                              visible: !0,
                                              timestamp: new Date().getTime(),
                        ...
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 3:
                                if (((n = e.sent), (this.params = n), !n)) {
                                  e.next = 8;
                                  break;
                                }
                                return (e.next = 8), this.payOrder(t);
                              case 8:
                              case 'end':
                                return e.stop();
                            }
              ...
              },
              {
                ...
                value: function (e, t) {
                  var r = e.commit;
                  xoyoConsole.log('表单值为', p()(t)), r(He, t);
              ...
              },
              {
                ...
                value: function (t, r) {
                  var a = r.link,
                    n = r.status,
                    i = '';
                  t.confirmOrder.orderInfo &&
                    (i = t.confirmOrder.orderInfo[0] && t.confirmOrder.orderInfo[0].value),
                    i || (i = e.account || ''),
    ...
    mt = [];
    function ft(e, t) {
      if ((t = t || document).getElementsByClassName) return t.getElementsByClassName(e);
      for (
        var r = [], a = t.getElementsByTagName('*'), n = new RegExp('\\b' + e + '\\b'), i = 0;
        i < a.length;
        i++
      )
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (e) {
                    ...
                    this.resolve(t), (this.value = t), this.onSuccessHandler(), this.close();
                  } else alert('请填写验证码!');
                },
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    dt(this.$input, 'keydown', function (e) {
                      13 === e.keyCode && (e.preventDefault(), i.click());
                    }),
                    r
                  );
                },
        ...
        return (
          b()(e, null, [
                  ...
                  return function (e) {
                    ...
                    t))
                      new RegExp('(' + r + ')').test(e) &&
                        (e = e.replace(
                          RegExp.$1,
                          1 === RegExp.$1.length ? t[r] : ('00' + t[r]).substr(('' + t[r]).length),
                        ));
                    return e;
            ...
            },
            {
              key: 'stampToDateTime',
              value: function (e) {
                if (e) return new Date(1e3 * e).toLocaleString().replace(/\//g, '-');
              },
            },
            {
              key: 'getUserInfo',
                  ...
                  e.logout(function () {
                    k.k.xoyoUrl.test(t)
                      ? (window.location.href =
                          w.a.signin.path + '?redirect=' + encodeURIComponent(t))
                      : (window.location.href = w.a.signin.path);
                  });
                });
              },
            },
    ...
    var At = r('4RXF'),
      ...
      Ot = {
        ...
        getNewsList: function (e) {
          return Object(At.a)(
            It + '/api/content/get.html?type=list&catid=' + e.catid + '&page=' + e.page,
            {
        ...
        getNewsContent: function (e) {
          return Object(At.a)(
            It + '/api/content/get.html?type=content&catid=' + e.catid + '&id=' + e.id,
            {
        ...
        getRobotList: function () {
          return Object(At.a)(
            It +
              '/api.php?op=search_api&action=get_article_list&pageSize=10&orderBy=listorder&sortBy=desc&moreInfo=1&catid=6973',
            {
              callbackName: 'xoyoGetDownload' + St(),
            },
          );
    ...
    var Tt = ot.a.backendServer,
      Pt = {
        ...
        getClientAntiAddictionState: function (e) {
          return Object(At.a)(
            Tt + '/passport/user_api/get_anti_addiction_state_by_client',
            n()({}, e),
          );
        },
        ...
        getWeakPasswordUpgradeStateByClient: function (e) {
          return Object(At.a)(
            Tt + '/passport/user_api/get_weak_password_upgrade_state_by_client',
            n()({}, e),
          );
        },
      ...
      Nt = {
        ...
        autoLogin: function (e) {
          return Object(At.a)(
            Dt + '/pay/recharge_api/auto_login' + window.location.search,
            n()({}, e),
          );
        },
        gameChannelInformation: function (e) {
          return Object(At.a)(
            Dt + '/pay/recharge_api/game_channel_information' + window.location.search,
            n()({}, e),
          );
        },
    ...
    var Ut = (function () {
        function e() {
          y()(this, e), (this.pf = null), (this.pf = o.a.prototype.$xoyo_api_common.getXoyoPf());
        }
        return (
          b()(e, [
            {
            ...
            [
              {
                key: 'getInstance',
                value: function (e) {
                  return t.instance ? t.instance : ((t.instance = new t(e)), t.instance);
                },
              },
            ],
          ),
      ...
      o.a.directive('st-report', {
        inserted: function (e, t) {
          var r = t.value,
            ...
            i = r.eventDataValue,
            o = void 0 === i ? {} : i,
            c = (r.eventGroup, r.eventTags),
            s = void 0 === c ? [] : c,
            u = r.listenEvent,
            l = void 0 === u ? 'click' : u,
            p = r.queryElement;
          ((void 0 === p ? function () {} : p).call(e) || e).addEventListener(l, function (e) {
            k.m.report({
              eventName: a,
              eventDescription: n,
              eventDataValue: o,
      ...
      o.a.directive('data-report', {
        inserted: function (e, t) {
          var r = t.value,
            ...
            i = void 0 === n ? 'click' : n,
            o = r.queryElement;
          ((void 0 === o ? function () {} : o).call(e) || e).addEventListener(i, function (e) {
            k.c[a] && k.c[a](), e.stopPropagation();
          });
        },
      }),
    ...
    t.a = function (e) {
      ...
      (e.store
        ? e.store.replaceState(n()({}, window.__INITIAL_STATE__, e.store.state))
        : window.__INITIAL_STATE__ && (e.data = n()(window.__INITIAL_STATE__, e.data && e.data())),
      t && r)
        ? new o.a(
            n()(
              {
    ...
    var a = {
        ...
        methods: {
          chargeTypeSelect: function (e) {
            this.$emit('input', e.value), this.dispatch('ElFormItem', 'el.form.change', e.value);
          },
        },
        created: function () {
      ...
      v = {
        ...
        methods: {
          ...
          showRobotService: function () {
            this.getRobotList(), (this.showRobotServiceModal = !0);
          },
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            ...
                            return e.abrupt('return');
                          case 2:
                            return (e.next = 4), t.$xoyo_api_content.getRobotList();
                          case 4:
                            (a = e.sent),
                              (i = a.data),
                              (r = !0),
