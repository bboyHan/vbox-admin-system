...
export function get_w(pass_time, user_resp, lot_number, dtime) {
  var d = (function () {
    var _,
      h,
      n,
  ...
  let pow_msg = powSignAndPowMsg['pow_msg'];
  let pow_sign = powSignAndPowMsg['pow_sign'];
  ...
  let json = d['default']['stringify'](e);
  console.log(json);
  console.log('---------------------');
  return get_h(json);
}
...
//   ]
// ]
// console.log(get_w(2466, x, 'ce10587215df47fab71518045fca83a3', '2023-02-09T23:43:41.705628+08:00'));
