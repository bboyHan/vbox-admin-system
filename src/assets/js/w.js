...
function get_w(passtime, userresponse, lot_number) {
  var d = function () {
    ...
    return "function" != typeof Date["prototype"]["toJSON"] && (Date["prototype"]["toJSON"] = function () {
    ...
    }, Boolean["prototype"]["toJSON"] = o, Number["prototype"]["toJSON"] = o, String["prototype"]["toJSON"] = o), s = {
      "\b": "\\b",
      "\t": "\\t",
      "\n": "\\n",
      "\f": "\\f",
      ...
      var a;
      if (p = u = "", "number" == typeof s) for (a = 0; a < s; a += 1) p += " ";else "string" == typeof s && (p = s);
        ...
        switch (_ && "object" == typeof _ && "function" == typeof _["toJSON"] && (_ = _["toJSON"](e)), "function" == typeof g && (_ = g["call"](t, e, _)), typeof _) {
          ...
          case "object":
            ...
            if (u += p, r = [], "[object Array]" === Object["prototype"]["toString"]["apply"](_)) {
              ...
              return o = 0 === r["length"] ? "[]" : u ? "[\n" + u + r["join"](",\n" + u) + "\n" + i + "]" : "[" + r["join"](",") + "]", u = i, o;
            }

            if (g && "object" == typeof g) for (n = g["length"], s = 0; s < n; s += 1) "string" == typeof g[s] && (o = c(a = g[s], _)) && r["push"](l(a) + (u ? ": " : ":") + o);else for (a in _) Object["prototype"]["hasOwnProperty"]["call"](_, a) && (o = c(a, _)) && r["push"](l(a) + (u ? ": " : ":") + o);
            return o = 0 === r["length"] ? "{}" : u ? "{\n" + u + r["join"](",\n" + u) + "\n" + i + "}" : "{" + r["join"](",") + "}", u = i, o;
        }
      }("", {
        "": e
  ...
  function get_h(e, t) {
    ...
    var _ = function () {
      ...
      s["prototype"]["init"] = function z(e) {
        ...
        for (t = s = 0; t < 256; ++t) s = s + this["S"][t] + e[t % e["length"]] & 255, a = this["S"][t], this["S"][t] = this["S"][s], this["S"][s] = a;
      ...
      if (null == o) {
        ...
        if (o = [], n = 0, window["crypto"] && window["crypto"]["getRandomValues"]) {
          ...
          for (window["crypto"]["getRandomValues"](_), i = 0; i < _["length"]; ++i) o[n++] = 255 & _[i];
        }

        var c = 0,
          u = function u(t) {
            if (256 <= (c = c || 0) || r <= n) window["removeEventListener"] ? (c = 0, window["removeEventListener"]("mousemove", u, !1)) : window["detachEvent"] && (c = 0, window["detachEvent"]("onmousemove", u));else try {
              var s = t["x"] + t["y"];
              o[n++] = 255 & s, c += 1;
            } catch (e) {}
          };
      ...
      t = "Microsoft Internet Explorer" == navigator["appName"] ? (v["prototype"]["am"] = function A(e, t, s, a, o, n) {
        var r = 32767 & t,
          i = t >> 15;
        ...
        while (0 <= --n) {
          ...
          o = ((_ = r * _ + ((32767 & u) << 15) + s[a] + (1073741823 & o)) >>> 30) + (u >>> 15) + i * c + (o >>> 30), s[a++] = 1073741823 & _;
        }

        return o;
      }, 30) : "Netscape" != navigator["appName"] ? (v["prototype"]["am"] = function S(e, t, s, a, o, n) {
        while (0 <= --n) {
        ...
        return o;
      }, 26) : (v["prototype"]["am"] = function M(e, t, s, a, o, n) {
        var r = 16383 & t,
          i = t >> 14;
        ...
        while (0 <= --n) {
          ...
          o = ((_ = r * _ + ((16383 & u) << 14) + s[a] + o) >> 28) + (u >> 14) + i * c, s[a++] = 268435455 & _;
        }
      ...
      return k["prototype"]["convert"] = function B(e) {
        ...
        for (var t = 0; t < this["m"]["t"]; ++t) {
          var s = 32767 & e[t],
            a = s * this["mpl"] + ((s * this["mph"] + (e[t] >> 15) * this["mpl"] & this["um"]) << 15) & e["DM"];
        ...
        while (0 <= --n) {
          ...
          _ < 0 ? "-" == e["charAt"](n) && (r = !0) : (r = !1, 0 == i ? this[this["t"]++] = _ : i + s > this["DB"] ? (this[this["t"] - 1] |= (_ & (1 << this["DB"] - i) - 1) << i, this[this["t"]++] = _ >> this["DB"] - i) : this[this["t"] - 1] |= _ << i, (i += s) >= this["DB"] && (i -= this["DB"]));
        }
        ...
        for (s = this["t"] - 1; 0 <= s; --s) t[s + r + 1] = this[s] >> o | i, i = (this[s] & n) << a;
        ...
        if (s >= this["t"]) t["t"] = 0;else {
          ...
          for (var r = s + 1; r < this["t"]; ++r) t[r - s - 1] |= (this[r] & n) << o, t[r - s] = this[r] >> a;

          0 < a && (t[this["t"] - s - 1] |= (this["s"] & n) << o), t["t"] = this["t"] - s, t["clamp"]();
        }
        ...
        t["s"] = a < 0 ? -1 : 0, a < -1 ? t[s++] = this["DV"] + a : 0 < a && (t[s++] = a), t["t"] = s, t["clamp"]();
        ...
        for (s = 0; s < t["t"] - 1; ++s) {
          ...
          (e[s + t["t"]] += t["am"](s + 1, 2 * t[s], e, 2 * s + 1, a, t["t"] - s - 1)) >= t["DV"] && (e[s + t["t"]] -= t["DV"], e[s + t["t"] + 1] = 1);
        }
        ...
        if (!(a["t"] <= 0)) {
          var o = this["abs"]();
          if (o["t"] < a["t"]) return null != t && t["fromInt"](0), void (null != s && this["copyTo"](s));
          null == s && (s = w());
          ...
          if (0 != u) {
            var p = u * (1 << this["F1"]) + (1 < c ? n[c - 2] >> this["F2"] : 0),
              ...
              f = h - c,
              m = null == t ? w() : t;
            n["dlShiftTo"](f, m), 0 <= s["compareTo"](m) && (s[s["t"]++] = 1, s["subTo"](m, s)), v["ONE"]["dlShiftTo"](c, m), m["subTo"](n, n);
        ...
        while (0 <= --n) if (t["sqrTo"](s, a), 0 < (e & 1 << n)) t["mulTo"](a, o, s);else {
          var r = s;
          s = a, a = r;
        }
        ...
        if (0 < r--) {
          ...
          while (0 <= r) i < t ? (s = (this[r] & (1 << i) - 1) << t - i, s |= this[--r] >> (i += this["DB"] - t)) : (s = this[r] >> (i -= t) & a, i <= 0 && (i += this["DB"], --r)), 0 < s && (o = !0), o && (n += m(s));
        }
        ...
        var t = function i(e, t) {
          ...
          while (0 <= a && 0 < t) {
            ...
            o < 128 ? s[--t] = o : 127 < o && o < 2048 ? (s[--t] = 63 & o | 128, s[--t] = o >> 6 | 192) : (s[--t] = 63 & o | 128, s[--t] = o >> 6 & 63 | 128, s[--t] = o >> 12 | 224);
          }
    ...
    var i = function () {
      var e,
        ...
        u = a["WordArray"] = o["extend"]({
          ...
          "concat": function (e) {
            var t = this["words"],
              ...
              a = this["sigBytes"],
              o = e["sigBytes"];
            if (this["clamp"](), a % 4) for (var n = 0; n < o; n++) {
        ...
        p = n["Latin1"] = {
          "parse": function (e) {
            for (var t = e["length"], s = [], a = 0; a < t; a++) s[a >>> 2] |= (255 & e["charCodeAt"](a)) << 24 - a % 4 * 8;
        ...
        i = a["BufferedBlockAlgorithm"] = o["extend"]({
          ...
          "$_BCFl": function (e) {
            "string" == typeof e && (e = r["parse"](e)), this["$_IJh"]["concat"](e), this["$_BCEV"] += e["sigBytes"];
          },
          "$_BCG_": function (e) {
            var t = this["$_IJh"],
              s = t["words"],
        ...
        c = a["Cipher"] = i["extend"]({
          ...
          "init": function (e, t, s) {
            this["cfg"] = this["cfg"]["extend"](s), this["$_BDAX"] = e, this["$_BDBI"] = t, this["reset"]();
          },
          "reset": function () {
          ...
          "$_BDFH": function (c) {
            return {
              "encrypt": function (e, t, s) {
                ...
                for (var a = b["encrypt"](c, e, t, s), o = a["ciphertext"]["words"], n = a["ciphertext"]["sigBytes"], r = [], i = 0; i < n; i++) {
        ...
        d = g["CBC"] = ((e = l["extend"]())["Encryptor"] = e["extend"]({
          "processBlock": function (e, t) {
            ...
            })["call"](this, e, t, a), s["encryptBlock"](e, t), this["$_BDIi"] = e["slice"](t, t + a);
          }
        }), e),
        h = (t["pad"] = {})["Pkcs7"] = {
          "pad": function (e, t) {
            for (var s = 4 * t, a = s - e["sigBytes"] % s, o = a << 24 | a << 16 | a << 8 | a, n = [], r = 0; r < a; r += 4) n["push"](o);
        ...
        f = a["BlockCipher"] = c["extend"]({
          ...
          "reset": function () {
            ...
            this["$_BDJg"] && this["$_BDJg"]["$_BEAq"] == a ? this["$_BDJg"]["init"](this, t && t["words"]) : (this["$_BDJg"] = a["call"](s, this, t && t["words"]), this["$_BDJg"]["$_BEAq"] = a);
          },
          "$_BCIr": function (e, t) {
      ...
      !function () {
        ...
        for (t = 0; t < 256; t++) {
          ...
          x[s] = _ << 24 | _ >>> 8, k[s] = _ << 16 | _ >>> 16, y[s] = _ << 8 | _ >>> 24, C[s] = _;
          _ = 16843009 * i ^ 65537 * r ^ 257 * n ^ 16843008 * s;
          z[o] = _ << 24 | _ >>> 8, T[o] = _ << 16 | _ >>> 16, E[o] = _ << 8 | _ >>> 24, A[o] = _, s ? (s = n ^ e[e[e[i ^ n]]], a ^= e[e[a]]) : s = a = 1;
        }
      }();
        ...
        M = _["AES"] = f["extend"]({
          "$_BDCI": function () {
            if (!this["$_BEBb"] || this["$_BECN"] !== this["$_BDBI"]) {
              for (var e = this["$_BECN"] = this["$_BDBI"], t = e["words"], s = e["sigBytes"] / 4, a = 4 * (1 + (this["$_BEBb"] = 6 + s)), o = this["$_BEDl"] = [], n = 0; n < a; n++) if (n < s) o[n] = t[n];else {
                var r = o[n - 1];
                n % s ? 6 < s && n % s == 4 && (r = v[r >>> 24] << 24 | v[r >>> 16 & 255] << 16 | v[r >>> 8 & 255] << 8 | v[255 & r]) : (r = v[(r = r << 8 | r >>> 24) >>> 24] << 24 | v[r >>> 16 & 255] << 16 | v[r >>> 8 & 255] << 8 | v[255 & r], r ^= S[n / s | 0] << 24), o[n] = o[n - s] ^ r;
              }

              for (var i = this["$_BEEk"] = [], _ = 0; _ < a; _++) {
                n = a - _;
                if (_ % 4) r = o[n];else r = o[n - 4];
                i[_] = _ < 4 || n <= 4 ? r : z[v[r >>> 24]] ^ T[v[r >>> 16 & 255]] ^ E[v[r >>> 8 & 255]] ^ A[v[255 & r]];
              }
            }
          },
          ...
          "$_BEFu": function (e, t, s, a, o, n, r, i) {
            for (var _ = this["$_BEBb"], c = e[t] ^ s[0], u = e[t + 1] ^ s[1], p = e[t + 2] ^ s[2], g = e[t + 3] ^ s[3], l = 4, d = 1; d < _; d++) {
  ...
  var pow_msg='1|0|md5|2022-07-09T21:54:54.851444+08:00|54088bb07d2df3c46b79f80300b0abbe|50769dab7275450db50550fcf351c95a||f93fd2ec831c936c',
...
x = [[2933, 6800], [1166, 1250], [7900, 3400]]
// console.log("dd \n  cc".trim().replace(/[\r\n]/g,"").replace(/\ +/g,""))
