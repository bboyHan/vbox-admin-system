...
<script lang="ts">
  ...
  import { columnsTx } from '/@/views/channel/resource/data';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { createTxCAccount } from '/@/api/channel/channel';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const [register, { setModalProps, closeModal }] = useModalInner(async (data) => {
        ...
        if (channelId.value.includes('tx')) {
          updateSchema({
            field: 'payType',
            componentProps: {
              options: [
      ...
      function handleCreate(record: Recordable) {
        try {
          ...
          console.log(record);
          let ret = createTxCAccount(record);
          console.log(ret);
