...
通道channel_id:  \`jx3_alipay\`  -  支付宝、\`jx3_weixin\` - 微信、\` jx3_jd\` - 京东  、\`jx3_ali_gift\`  -  支付宝(固额特惠) 、\`jx3_wx_gift\`  -  微信(固额特惠)、\` tx_jym\` - 支付宝JYM、\` tx_dy\` - 腾讯抖音 (固额)、\` tx_tb\` - 腾讯淘宝 (固额)、\` tx_tb\` - 腾讯京东 (固额)
...
| money      | 金额         | int           | 是       | 单位：元，必须为10的倍数，范围是10-30,000。其中：jx3_ali_gift特惠，只允许4种固额传参（分别为76,156,162,276）。tx_tb，只允许5种固额传参（分别为30,50,100,200,300）。tx_dy或tx_jd，只允许5种固额传参（分别为50,100,200,300,500）                  |
